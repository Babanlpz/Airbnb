...
import { SiCampaignmonitor, SiOpensea } from "react-icons/si";
    ...
    <div className="relative pt-6 px-10 flex items-center gap-3">
      {scrollPosition > 0 && (
        <button
          ...
          className="p-1 bg-white rounded-full border border border-black z-index font-bold flex items-center justify-center text-sm"
        >
          <RiArrowLeftSLine />
        </button>
      )}
          ...
          <div className="flex items-center">
            {categoriesList.map((category, index) => (
              <div key={index} className="w-32 flex-shrink-0">
                <div className="flex flex-col items-center cursors-pointer border-b-2 border-[#fff] hover:border-b-2 hover:border-[#484848]">
